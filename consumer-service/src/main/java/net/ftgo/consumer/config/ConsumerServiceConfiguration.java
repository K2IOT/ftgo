...
/**
 * Configuration for Consumer Service messaging infrastructure.
 * 
 * Configures:
...
public class ConsumerServiceConfiguration {
    ...
    /**
     * Creates the command dispatcher for Consumer Service.
     * 
     * @param consumerCommandHandlers the command handlers
