...
class SecuritySmokeTest {
    ...
    @Test
    void rejectsDirectDeliveryRequestWithoutToken() throws Exception {
        mockMvc.perform(get("/deliveries/security-probe"))
            .andExpect(status().isUnauthorized());
    }

    @Test
    void rejectsAuthenticatedUserWithoutCourierRole() throws Exception {
    ...
    public static class ProbeController {
        ...
        @GetMapping("/deliveries/security-probe")
        String deliveryProbe() {
            return "ok";
        }
