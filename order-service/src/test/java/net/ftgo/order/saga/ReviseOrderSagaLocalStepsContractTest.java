...
class ReviseOrderSagaLocalStepsContractTest {
    ...
    @Test
    void undoReviseCompensationRestoresApprovedStateWithoutPublishingOrderEvent() {
        ReviseOrderSagaLocalSteps localSteps = new ReviseOrderSagaLocalSteps(
            orderRepository,
            eventPublisher,
        ...
        localSteps.undoReviseOrder(101L);
