...
public class DomainEventPublisher {
    ...
    /**
     * Publishes a domain event for a Restaurant aggregate.
     * 
     * @param aggregateId the restaurant ID
    ...
    public void publishRestaurantEvent(Long aggregateId, Object event) {
        try {
            ...
            logger.info("Published {} event for Restaurant {} to outbox", eventType, aggregateId);
